---
title: "MSME Delayed Payment Interest Rate: 3x RBI Bank Rate Rules & Section 16 Calculation (2026)"
description: "Check MSME delayed payment interest rates (2026). Learn the 3x RBI bank rate rule under Section 16, 45-day payment deadline, and compound interest math."
pubDate: "2026-09-15"
updatedDate: "2026-09-15"
heroImage: "/images/blog/msme-delayed-payment-interest-rate-2026.svg"
tags: ["MSME", "Delayed Payment", "Interest Rates", "RBI Rules", "Section 43B(h)"]
---

Delayed payments from large corporate buyers, government departments, and mid-sized enterprises have long been the single biggest cause of working capital distress for micro and small enterprises across India. To eliminate this issue and protect registered suppliers, Chapter V of the **Micro, Small and Medium Enterprises Development (MSMED) Act, 2006** enforces some of the strictest statutory interest penalties in Indian commercial law.
...
<div class="my-6 p-6 rounded-xl border-2 border-primary/20 bg-primary/5 dark:bg-primary/10 text-center not-prose">
  <p class="text-xs font-mono uppercase tracking-wider text-primary font-semibold mb-1">Interactive Statutory Tool</p>
  <h3 class="text-xl font-bold text-base mb-2">Calculate Your Delayed Payment Interest</h3>
  <p class="text-sm text-muted mb-4 max-w-lg mx-auto">Compute exact 3× RBI compound interest with monthly rests for any overdue invoice under Section 16 of the MSMED Act.</p>
  <a href="/msme-delayed-payment-calculator" class="inline-flex items-center gap-2 px-6 py-2.5 rounded-lg bg-primary hover:bg-primary/90 text-white font-semibold transition-all shadow-sm">
    Open MSME Delayed Payment Calculator →
  </a>
</div>

---

## What is the Mandatory Payment Timeline? (Section 15 of MSMED Act)

Section 15 establishes strict statutory timelines within which the buyer must pay for goods or services supplied by an enterprise:

1. **Where there is a written agreement**: The agreed payment period cannot exceed **45 days** from the date of acceptance or deemed acceptance. Any agreement clause stipulating 60, 90, or 120 days is void under law.
2. **Where there is no written agreement**: Payment must be released within **15 days** (the "appointed day") from the date of physical delivery of goods or completion of services.
3. **Objection Period**: If the buyer has any valid dispute or objection regarding the quality or quantity of goods, they must notify the supplier in writing within **15 days** of delivery.

---

## MSME Interest Rate on Delayed Payment: Section 16 Statutory Rules

If a buyer fails to make payment on or before the due date, **Section 16 of the MSMED Act** automatically triggers statutory interest:
...
## The Tax Penalty: Section 23 of MSMED Act & Section 43B(h)

The financial damage to a defaulting buyer extends far beyond commercial interest:

### 1. Inadmissibility of Interest Expense (Section 23 MSMED Act)
Under Section 23 of the MSMED Act, the interest paid or payable by a buyer to an MSME supplier on delayed payments **cannot be deducted as a business expense** when computing taxable income under the Income Tax Act, 1961. It is permanently disallowed.
...
## How MSMEs Can Recover Delayed Payments (MSME Samadhaan)

If a buyer refuses to pay the principal or statutory interest, registered suppliers have access to a fast-track statutory recovery mechanism:

1. **Registration Requirement**: The supplier must hold a valid **Udyam Registration Certificate** before the date of invoice.
2. **Filing on MSME Samadhaan**: File an online complaint on the Ministry of MSME's portal ([samadhaan.msme.gov.in](https://samadhaan.msme.gov.in)) attaching the invoice, purchase order, and proof of delivery.
3. **Micro and Small Enterprise Facilitation Council (MSEFC)**: The case is referred to the state MSEFC council, which must decide the matter within 90 days.
4. **Appeals Require 75% Deposit**: Under Section 19 of the MSMED Act, if the buyer appeals the MSEFC award in court, they must pre-deposit **75% of the awarded amount** before their appeal can even be entertained.
...
### Can a buyer avoid interest if the contract says "No interest for delay"?
No. Section 16 of the MSMED Act contains an overriding non-obstante clause ("notwithstanding anything contained in any agreement"). Any contract clause attempting to eliminate or reduce the 3× RBI interest rate is null and void.
